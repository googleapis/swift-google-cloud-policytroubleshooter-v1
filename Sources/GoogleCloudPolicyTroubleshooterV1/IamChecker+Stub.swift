...
extension Clients {
  ...
  class IamCheckerTransport: IamCheckerStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://policytroubleshooter.googleapis.com")
    }
    ...
    public func troubleshootIamPolicy(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicyTroubleshooterV1.TroubleshootIamPolicyResponse.self, from: data)
    }
  }
}
